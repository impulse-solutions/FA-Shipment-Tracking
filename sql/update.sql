...
CREATE TABLE `0_shipments` (
  ...
  `shipment_tracking_no` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipment_vehicle_no` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipment_eway_bill` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `0_options` (
  ...
  `column_value` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `inactive` tinyint(1) NOT NULL DEFAULT '0',
